...
export default function Home() {
  ...
  // Add this useEffect at the top with other effects
  useEffect(() => {
    // Set isLoaded to true after a small delay to ensure smooth animation
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center pt-20 px-8 sm:px-20 relative overflow-hidden">
        {/* Animated background decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-[40%] -left-[20%] w-[80%] h-[80%] rounded-full bg-gradient-to-br from-blue-600/20 to-purple-600/20 blur-3xl animate-blob"></div>
          <div className="absolute -bottom-[40%] -right-[20%] w-[80%] h-[80%] rounded-full bg-gradient-to-br from-purple-600/20 to-pink-600/20 blur-3xl animate-blob animation-delay-2000"></div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="space-y-8">
            <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
              <div className={`max-w-xl relative mt-12 md:mt-0 transition-all duration-1000 ease-out transform
                ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                {/* Decorative elements */}
                <div className="absolute -left-8 -top-8 w-20 h-20 bg-blue-600/10 rounded-full blur-xl" />
                <div className="absolute -right-8 -bottom-8 w-20 h-20 bg-purple-600/10 rounded-full blur-xl" />
                
                <h1 className={`text-4xl sm:text-6xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 
                ...
                <div className={`mt-4 h-8 flex items-center gap-2 transition-all duration-1000 delay-500 ease-out transform
                              ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <div className="w-2 h-2 bg-blue-600 rounded-full animate-ping"></div>
                  <div className="relative overflow-hidden h-8 w-[220px]">
                    {roles.map((role, idx) => (
                      <span
                        key={role}
                        className={`
                          ...
                          text-lg sm:text-xl text-gray-600 dark:text-gray-300 font-light flex items-center
                        `}
                ...
                <p className={`mt-6 text-xl text-gray-600 dark:text-gray-300 transition-all duration-1000 delay-700 ease-out transform
                            ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  A passionate Full Stack Developer crafting digital experiences with creativity and precision
                </p>
                <div className={`mt-8 flex items-center justify-center gap-6 transition-all duration-1000 delay-1000 ease-out transform
                              ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <button 
                    onClick={() => scrollToSection('projects')}
                    className="group px-6 py-3.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full 
                  ...
                  <button 
                    ...
                    className="group px-6 py-3.5 border-2 border-blue-600 text-blue-600 dark:border-blue-400 
                  ...
                  <a 
                    href="/RESUME.pdf"
                    download
                    className="group px-6 py-3.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full 
                ...
                {/* Add Social Icons */}
                <div className={`mt-8 flex gap-6 transition-all duration-1000 delay-[1200ms] ease-out transform
                              ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className={`flex-shrink-0 relative -mt-48 transform -translate-y-12 transition-all duration-[1500ms] ease-out
                            ${isLoaded ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 -translate-y-16 scale-90'}`}>
                <div className={`absolute inset-[-12px] bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-full blur-3xl
                              transition-all duration-[2000ms] delay-500
                              ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-150'}`} />
                <div className={`absolute inset-[-8px] bg-gradient-to-br from-blue-500/40 to-purple-500/40 rounded-full blur-2xl
                              transition-all duration-[2000ms] delay-700
                              ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-125'}`} />
                <div className={`absolute inset-[-4px] bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-xl
                ...
                <div className="relative w-48 h-48 md:w-56 md:h-56 animate-float">
                  <div className={`absolute inset-0 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full 
                                ...
                                ${isLoaded ? 'opacity-100 rotate-0' : 'opacity-0 rotate-180'}`}></div>
        ...
        <div className="max-w-4xl mx-auto px-8 sm:px-20 relative">
          ...
          <div className={`mt-12 transition-all duration-1000 ease-out transform
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                { name: 'React', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/react/react-original.svg', style: 'bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-800/40' },
                { name: 'Next.js', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/nextjs/nextjs-original.svg', style: 'bg-black/[0.05] hover:bg-black/[0.08] dark:bg-black/30 dark:hover:bg-black/40' },
                { name: 'TypeScript', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/typescript/typescript-original.svg', style: 'bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-800/40' },
                { name: 'Node.js', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/nodejs/nodejs-original.svg', style: 'bg-green-50 hover:bg-green-100 dark:bg-green-900/30 dark:hover:bg-green-800/40' },
                { name: 'Tailwind', logo: 'https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg', style: 'bg-cyan-50 hover:bg-cyan-100 dark:bg-cyan-900/30 dark:hover:bg-cyan-800/40' },
                { name: 'CSS', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/css3/css3-original.svg', style: 'bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-800/40' },
                { name: 'PHP', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/php/php-original.svg', style: 'bg-purple-50 hover:bg-purple-100 dark:bg-purple-900/30 dark:hover:bg-purple-800/40' },
                { name: 'MySQL', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/mysql/mysql-original.svg', style: 'bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-800/40' },
                { name: 'HTML', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/html5/html5-original.svg', style: 'bg-orange-50 hover:bg-orange-100 dark:bg-orange-900/30 dark:hover:bg-orange-800/40' },
                { name: 'Bootstrap', logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/bootstrap/bootstrap-plain.svg', style: 'bg-purple-50 hover:bg-purple-100 dark:bg-purple-900/30 dark:hover:bg-purple-800/40' },
                ...
                <div 
                  key={tech.name} 
                  className={`group relative px-3 py-2.5 rounded-lg flex items-center gap-2 transition-all duration-150 ease-out
                            hover:shadow-md cursor-pointer ${tech.style} w-full
                            ${aboutContentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                  style={{ transitionDelay: aboutContentVisible ? `${0.5 + idx * 0.1}s` : '0s' }}
                >
                  <div className="flex-shrink-0 relative z-10">
                  <img 
                    src={tech.logo} 
                    alt={tech.name} 
                      className="w-5 h-5 transition-all duration-150 ease-out transform group-hover:scale-110 group-hover:rotate-3" 
                  />
                  </div>
                  <span className="text-xs font-medium text-gray-800 dark:text-gray-200 transition-all duration-150 ease-out z-10
                                 group-hover:text-gray-900 dark:group-hover:text-white group-hover:font-semibold break-words leading-tight">
                    {tech.name}
                  </span>
                  <div className="absolute inset-0 bg-white/5 dark:bg-white/10 opacity-0 group-hover:opacity-100 
                               rounded-lg transition-all duration-150 ease-out pointer-events-none" />
                </div>
              ))}
            </div>
          </div>
